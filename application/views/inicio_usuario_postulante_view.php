                    ...
                    <div class="container-fluid">
                        ...
                        <div class="collapse navbar-collapse" id="navbar-1">
                            <ul class="nav navbar-nav">
                                ...
                                <li class="active"><?php echo anchor("usuario_controller/inicio_postulante", "<span class='glyphicon glyphicon-home'></span> Inicio"); ?> </li>
            ...
            <div class="container">
                <div class="col-md-12">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <p>
                                A continuación se menciona los cursos más destacados con su breve descripción.
                ...
                <div class="row">
                        ...
                        <div class="thumbnail">
                            ...
                            <div class="caption">
                                <p>Android es el rey indiscutible de las aplicaciones  
                                    (Aunque no debamos menospreciar a iOS).
                                    Se dedica a crear aplicaciones para Android, si se hace bien, puede ser muy rentable. 
                                    Y podrá desarrollar juegos para Android, también.</p>
                    ...
                    <div class="col-xs-12 col-md-3">
                        <div class="thumbnail">
                            ...
                            <div class="caption">
                                <p>AngularJS es un framework MVC de código abierto desarrollado por Google y  JavaScript,
                                    que trabaja del lado del cliente y nos permite hacer más dinámica nuestra aplicación web,
                                    trabajando de la mano con otras tecnologías.</p>
                ...
                <div class="row ">
                    <div class="col-xs-12 col-md-3">
                        <div class="thumbnail">
                            ...
                            <div class="caption">
                                <p>HTML5 es un lenguaje markup (de hecho, las siglas de HTML significan Hyper Text Markup Language)
                    ...
                    <div class="col-xs-12 col-md-3">
                        <div class="thumbnail">
                            ...
                            <div class="caption">
                                <p>Java es un lenguaje de programación de propósito general, concurrente, orientado a
                                    objetos que fue diseñado específicamente   para tener tan pocas dependencias de 
                                    implementación como fuera posible Su intención  es permitir portabilidad.</p>
                    ...
                    <div class="col-xs-12 col-md-3">
                        <div class="thumbnail">
                            ...
                            <div class="caption">
                                <p>Node es un programa de servidor. Sin embargo, el producto base  de Node definitivamente 
                                    No es como Apache o Tomcat. Esos servidores  básicamente son productos para servidor 
                                    listos para instalar.</p>
                    ...
                    <div class="col-xs-12 col-md-3">
                        <div class="thumbnail">
                            ...
                            <div class="caption">
                                <p>PHP es un lenguaje de código abierto muy popular, adecuado para  desarrollo 
                                    web y que puede ser incrustado en HTML. Es popular   porque un gran número 
                                    de páginas y portales web están creadas con PHP. </p>
