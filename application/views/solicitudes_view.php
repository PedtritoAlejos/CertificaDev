...
<html>
    ...
    <!--                            <li><a href=""> Solicitudes pendientes <span class="badge">15</span></a> </li>-->
                                <li class="active"> <?php echo anchor("usuario_controller/usuario_solicitudes", "<span class='glyphicon glyphicon-folder-open'></span> Solicitudes pendientes <span class='badge'>" . $total . "</span>"); ?> </li>
                                <li class="dropdown">
                    ...
                    <table class="table  table-bordered table-hover ">
                        ...
                        if (isset($datos)) {
                            foreach ($datos->result() as $fila) {
                                ...
                                echo "<td>";
                                echo form_open("usuario_controller/info");
                    ...
                    <div class="col-md-12">
                        <div class="panel panel-info">
                            ...
                            <div class="panel-body">
                                ...
                                Haciendo click en el botón ver se desplegara la información.<br/>
